...
public class CategoryDTO implements DataResponseDTO {
  ...
  */
  ...
  @Schema(name = "id", example = "8", required = false)
  public Long getId() {
    return id;
  }
  ...
  */
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, name, parentCategoryId, dateCreated, dateDeleted, type);
  }
