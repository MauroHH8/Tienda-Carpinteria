...
class ProductDTO {
     ...
     */
    constructor(price, qty, category, dateCreated) { 
        
        ProductDTO.initialize(this, price, qty, category, dateCreated);
    }
     ...
     */
    static initialize(obj, price, qty, category, dateCreated) { 
        obj['price'] = price;
        obj['qty'] = qty;
